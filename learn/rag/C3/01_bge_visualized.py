...
with torch.no_grad():
    ...
    img_emb_1 = model.encode(image="./imgs/datawhale01.png")
    multi_emb_1 = model.encode(image="./imgs/datawhale01.png", text="datawhale开源组织的logo")
    img_emb_2 = model.encode(image="./imgs/datawhale02.png")
    multi_emb_2 = model.encode(image="./imgs/datawhale02.png", text="datawhale开源组织的logo")
